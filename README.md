...
Cloud VPC Design: Creating subnets for different tiers (web, app, database)
Container Networks: Docker assigns IP addresses from a subnet (usually 172.17.0.0/16)
Kubernetes Pods: Each pod gets its own IP address
Security Groups: Allow traffic from specific IP ranges (e.g., 10.0.1.0/24)
Key Takeaways
